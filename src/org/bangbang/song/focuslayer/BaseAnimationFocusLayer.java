...
public class BaseAnimationFocusLayer extends AbsoluteLayout  implements IFocusAnimationLayer {
    ...
    private static final int DEFAULT_ANIMATION_DURATION = 222;
    ...
    protected boolean mDisableScale;
    ...
    private void init() {
        mFocusRectView = onInflateFocusRectView(((LayoutInflater)getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)));  
    ...
    /**
     * inflate focus view, but NOT add to view hierarchy, caller will do this for u. 
     * 
     * @param layoutInflater
     * @return
     */
    protected BaseAnimationFocusLayer.FixedSizeView onInflateFocusRectView(LayoutInflater layoutInflater) {
...
//          Log.d(TAG, "measuredWidth: " + MeasureSpec.toString(measuredWidth) + " measuredHeight: " + MeasureSpec.toString(measuredHeight));
